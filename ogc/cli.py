...
RANKS = [str(i) for i in range(1, 9)]  # ordinal, sheet 10-46: 1 ISO 9000, 2 SEVOCAB, 3 NIST, 4 W3C, 5 ISO-family vocabularies, 6 other bodies, 7 academic works, 8 the authors
