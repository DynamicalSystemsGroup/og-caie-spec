...
step "drift: the consistency loop, mechanical layer (appendix letters, stale phrases, retired words, file mentions, sheet ticks, twins, absence rows)" 0 uv run python scripts/drift_check.py
