...
Rulings R-21 and R-23 introduced the parties. Z: tick each row after checking the quote against the screenshot (or the OBP page for ISO/IEC 17000). Row 7 was ticked on Z's capture of clauses 3.3.9 to 3.3.13 as `iso-9000-2026-obp-38.png` (ruling R-27).
