...
- Rendered here: `generated/steps-contracting.md`, `generated/wiring-contracting.md`, `generated/sci-contracting.md`, `generated/record-contracting.md`, regenerated from the graphs by the gate (`checks/run-checks.sh`, the one script that runs every check and prints PASS or FAIL) and diffed byte for byte.
