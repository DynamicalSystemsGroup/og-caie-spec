...
| C3 agree | `statement-of-work` (StatementOfWork) | scope of work under the agreement: the commuters are interviewed, the county residents are represented by the domain expert | county public-health office (sponsor) | 2026-07-31 |
| C4 access | `test-item-access` (TestItemAccess) | API access to chatbot v1 for the evaluation | chatbot vendor (accountable for the test item) | 2026-07-31 |
| C5 deliver | `delivery-1` (Delivery) | report and recommendation delivered to the county public-health office | Mala (account executive) | 2026-08-12 |
| C6 accept | `acceptance-1` (Acceptance) | the county public-health office accepts the delivery | county public-health office (sponsor) | 2026-08-14 |
