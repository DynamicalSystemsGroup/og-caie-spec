...
: The person who signs the contract for the testing organization and delivers the report and the recommendation to the sponsor: the organization's interface with its contractual counterparties. The authorized representative is not responsible for the determinations in the report; those belong to the technical experts, and the representative makes no determination and no attestation. An abstract actor category, filled by exactly one named person in each evaluation. Source: IEEE Computer Society, acceptance, p. 4 (ISO/IEC/IEEE 24748-5:2017, 3.1) (fragment of the entry): "authorized representative of the acquirer". Also: account executive, signatory. Ruling R-23, R-48.
...
contract
: The binding agreement between the sponsor organization and the testing organization to perform OG-CAIE as a service. It is signed by the sponsor and by the testing organization's authorized representative, precedes the requirement set, and is the first item the record holds. Source: ISO 9000:2026(en) Quality management — Fundamentals and vocabulary, 3.3.13: "binding agreement". Also: agreement, service agreement. Ruling R-21.
