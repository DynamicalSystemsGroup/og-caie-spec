...
- Ask the graph: `ogc execute`, `ogc execute --planned 3`, `ogc execute --mutate skip-access`, `ogc sci SCI-11`, `ogc term "test coverage"`, `ogc term "requirements traceability"`, `ogc sparql`.
