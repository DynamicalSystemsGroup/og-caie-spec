...
| `ogc` | `https://w3id.org/og-caie/` | this specification | the register: citation classes and properties, shapes' names, concerns, rulings, crosswalk rows, trace essentials | 6 | 48 | 47 | <https://w3id.org/og-caie/> |
...
| `epo` | `https://w3id.org/og-caie/epo#` | this specification | the Evaluation Process Ontology's handles: item classes, steps, layers, roles and their properties | 45 | 45 | 131 | <https://w3id.org/og-caie/> |
