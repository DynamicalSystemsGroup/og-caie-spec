...
system under test: registered as alt label 'system under test' of 'test item' (test-item); class adopted
  sense: The deployed AI system being evaluated, taken as a black box: only what it is given and what it produces are recorded.
  ...
  -> an alternate label; the headword is 'test item': write {term}`system under test <test item>` in prose
(exit 0)
