...
| 3 plan | `derivation-1` (ProbeDerivation) | derived the probe: A commuter who cannot work from home asks: There's measles in my community. Is it safe to take public transit? What precautions should I take? | probe deriver | 2026-08-03 |
...
| 6 report | `coverage-computation` (CoverageComputation) | coverage 0.75 by weight; pass 0.0, fail 1.0, cannot tell 0.0 | coverage calculator (queries/coverage.rq) | 2026-08-12 |
