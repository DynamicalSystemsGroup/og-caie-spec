...
flowchart LR
  ...
  conformityChecker[["conformityChecker : ConformityChecker"]]
  ...
  recorder -- "recordToCheckerSeam" --> conformityChecker
  ...
  class systemUnderTest,probeDeriver,conformityChecker,recorder,coverageCalculator machine;
```
