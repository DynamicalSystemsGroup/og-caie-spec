...
| `counterexamples/population-unrepresented.ttl` | False | S0-Population, S0-StatementOfWork | S0: an affected population is engaged as the statement of work decided (R-21, R-40): interviewed, with a stakeholder input attributed to it, or represented by a named domain expert; and there is a decision for it. / S0: the statement of work decides, for every affected population, exactly once, interview or representation (R-40). |
